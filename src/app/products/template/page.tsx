...
export async function generateMetadata(): Promise<Metadata> { return { title: tr(await getLocale(),"Product detail template") }; }
const groups = [
  ...
  { title: "Classification", fields: ["Product category", "Subcategory", "Product format", "Delivery route", "Contains tobacco", "Tobacco-free", "Nicotine source", "Product technology"] },
