...
const fields = ["Brand", "Product", "Product category", "Product format", "Nicotine strength", "Nicotine per unit", "Contains tobacco", "Nicotine source", "Flavor", "Unit weight", "Country of origin", "Markets", "Delivery route", "Status"];
...
function productValue(product: Product, field: string, locale: "en" | "zh"): string {
  ...
  const values: Record<string, string | undefined> = {
    ...
    Status: tr(locale, product.status),
  };
  return values[field] || "—";
}
